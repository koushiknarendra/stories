...
export default function StoryReader({ set }: { set: StorySet }) {
  ...
  return (
    <div style={{ height: "100dvh", display: "flex", flexDirection: "column", overflow: "hidden", userSelect: "none", background: "#000" }}>
      ...
      {/* Card — fills ALL remaining height, edge to edge, goes to bottom of screen */}
      <div style={{ flex: 1, minHeight: 0, position: "relative" }}>
        ...
        >
          {/* Gradient background — fills full card */}
          ...
          {/* Bottom overlay — content + action buttons on top of gradient */}
          <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(transparent 0%, rgba(0,0,0,0.6) 30%, rgba(0,0,0,0.92) 100%)", padding: "80px 22px 0", zIndex: 10 }}>
            ...
            {/* Action buttons — inside the overlay, above safe area */}
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 32, padding: "22px 0 44px" }}
            ...
            >
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
                ...
                <span style={{ ...SG, fontSize: 10, color: "rgba(255,255,255,0.35)", fontWeight: 600, letterSpacing: ".06em" }}>Less of this</span>
              </div>
