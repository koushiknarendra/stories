    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            {/* Loading screen replaces form content while converting */}
            {loading ? (
                  ...
                  {!done && tab === "link" && (
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      ...
                      <button
                        ...
                        style={{ ...SG, padding: "14px 0", borderRadius: 12, border: "none", background: accent, color: "#fff", fontWeight: 700, fontSize: 15, cursor: !urlInput.trim() ? "not-allowed" : "pointer", opacity: !urlInput.trim() ? 0.65 : 1, boxShadow: "0 4px 16px -4px rgba(124,92,255,0.5)", transition: "opacity .15s" }}
                      >
                        Convert to cards
                      </button>
                    </div>
                  ...
                  {!done && tab === "text" && (
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      ...
                      <button
                        ...
                        style={{ ...SG, padding: "14px 0", borderRadius: 12, border: "none", background: accent, color: "#fff", fontWeight: 700, fontSize: 15, cursor: !textInput.trim() ? "not-allowed" : "pointer", opacity: !textInput.trim() ? 0.65 : 1, boxShadow: "0 4px 16px -4px rgba(124,92,255,0.5)", transition: "opacity .15s" }}
                      >
                        Convert to cards
                      </button>
                    </div>
